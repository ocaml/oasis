...
(* OASIS_START *)
(* DO NOT EDIT (digest: b18956cf7f725d1d2b25cc0d11123734) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build OASIS benchmark";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "guess-cmx.ml"});
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "oasis-announce.ml"});
               Executable
                 ({
                     cs_name = "oasis-dist";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "oasis-dist.ml"});
               Library
                 ({
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\254@\177\183\2201\015\130\020\176#6\016\165\127y";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
