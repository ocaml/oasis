...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9407a31530dbb823b02b14eaf9524daf) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports =
            Some
              "https://forge.ocamlcore.org/tracker/?func=add&group_id=54&atid=291";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "u\183\169SA\1440p\bV\031rL\235'o";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
