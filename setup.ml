...
(* OASIS_START *)
(* DO NOT EDIT (digest: fbd2bb430005186b7ce74dc51f4803e2) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_devel", []))];
     ...
     package =
       {
          ...
          alpha_features = ["source_patterns"; "stdfiles_markdown"];
          beta_features = [];
          name = "oasis";
          ...
          bugreports = Some "https://github.com/ocaml/oasis/issues";
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build OASIS tools for development";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                     cs_name = "quickstart_tests";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description = Some "Build test-quickstart";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build test-omake";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build test-devel";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "git://github.com/ocaml/oasis.git";
                      src_repo_browser =
                        Some "https://github.com/ocaml/oasis";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      ...
                      src_repo_module = None;
                      src_repo_branch = Some "opam/testing";
                      src_repo_tag = None;
                      src_repo_subdir = None
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["TestCommon"; "TestFullUtils"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "FakeOCamlfind.ml"});
               Executable
                 ({
                     cs_name = "test-main";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                        ...
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "tests",
                                OASISExpr.EFlag "omake_tests"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "test/test-omake";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage
                   ...
                   {exec_custom = false; exec_main_is = "TestOMake.ml"});
               Executable
                 ({
                     cs_name = "test-quickstart";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "tests",
                                OASISExpr.EFlag "quickstart_tests"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "test/test-quickstart";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage
                   ...
                   {exec_custom = false; exec_main_is = "TestQuickstart.ml"});
               Executable
                 ({
                     cs_name = "test-devel";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "tests",
                                OASISExpr.EFlag "devel_tests"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "test/test-devel";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage
                   ...
                   {exec_custom = false; exec_main_is = "TestDevel.ml"});
               Executable
                 ({
                     cs_name = "dist";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "devel", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "src/tools/dist";
                   ...
                   {exec_custom = false; exec_main_is = "Dist.ml"});
               Executable
                 ({
                     cs_name = "guess-cmx";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "GuessCMX.ml"});
               Executable
                 ({
                     cs_name = "oasis-announce";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "src/tools/oasis-announce";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oasis";
                   ...
                   {exec_custom = false; exec_main_is = "OASISAnnounce.ml"});
               Executable
                 ({
                     cs_name = "oasis-dist";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "OASISDist.ml"});
               Executable
                 ({
                     cs_name = "bench";
                     cs_data = PropList.Data.create ();
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules =
                        ["CLIData"; "CLIPluginsLoaded"; "CLIPluginLoader"];
                      lib_findlib_parent = Some "oasis";
                      lib_findlib_name = None;
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           ExternalTool "make";
                           InternalExecutable "oasis";
                           InternalExecutable "test-quickstart"
                        ]
                   });
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           ExternalTool "make";
                           InternalExecutable "oasis";
                           InternalExecutable "test-omake";
                           ExternalTool "ocamlmod";
                           InternalExecutable "fake-ocamlfind";
                           ExternalTool "omake";
                           ExternalTool "camlp4"
                        ]
                   });
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "PluginLoaderMain.ml"
                   });
               Executable
                 ({
                     cs_name = "test_loader";
     ...
     oasis_digest = Some "\158\152\204\212\031',\184?\139j\246 )\024\148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
