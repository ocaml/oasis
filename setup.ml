...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8a50f5883efb10ed988a90fba0ea1433) *)
(*
   Regenerated by OASIS v0.3.0~rc4
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0~rc4";
     oasis_digest = Some "_\179\023hz\250\213,\228\016@\137\020\001(\183";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = true;
     };;
