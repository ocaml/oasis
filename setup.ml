...
(* OASIS_START *)
(* DO NOT EDIT (digest: 34f8fa4733dfff89f4139f1f2a325be5) *)
(*
...
let setup_t =
  {
     ...
     oasis_digest = Some "\135BfB\253\167\003\\\012\220\168\193\224\163\243a";
     oasis_exec = None;
     oasis_setup_args = [];
     };;
