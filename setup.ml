...
(* OASIS_START *)
(* DO NOT EDIT (digest: 02e965d22cbd7e6069edbd61218a1235) *)
(*
...
# 1 "src/oasis/OASISFeatures.ml"
  ...
  let get_stage name =
    try
      match (Hashtbl.find all_features name).publication with
        | InDev stage -> Some stage
        | SinceVersion _ -> None
    with Not_found ->
...
let setup_t =
  {
     ...
     oasis_version = "0.4.0";
     oasis_digest = Some "q\185\160\139;\185\180\220\234R\160G\155\025Ke";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
