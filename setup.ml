...
(* OASIS_START *)
(* DO NOT EDIT (digest: bcaad7737acd6c0b43bdcb7d714a06e9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports =
            Some "https://forge.ocamlcore.org/tracker/?group_id=54";
          synopsis =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\183\150\201\169\230\180;,L=\157\233\198\028\182g";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
